...
public class pvp extends javax.swing.JFrame implements GameState {
    ...
    public pvp(int choice1,int choice2, int background) {
        initComponents();
    ...
    public void initCharacters(int choice1, int choice2) {
        switch (choice1)
        {
            ...
            case 3: lblPlayer1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Migantron/idle/char-miganIdle-unscreen.gif")));
                break;
            case 4: lblPlayer1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Sir Khai/idle/char-skIdle-unscreen.gif")));
                break;
            default:;
        }
        ...
        switch (choice2)
        {
            case 1: lblPlayer2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Brett/idle/char-brettIdle-unscreen.gif")));
                break;
            case 2: lblPlayer2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Gabe/idle/char-gabeIdle-unscreen.gif")));
                break;
            case 3: lblPlayer2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Migantron/idle/char-miganIdle-unscreen.gif")));
                break;
            case 4: lblPlayer2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Sir Khai/idle/char-skIdle-unscreen.gif")));
                break;
            default:;
        }
    }
